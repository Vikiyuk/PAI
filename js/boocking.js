...
obiektTown = /^[a-zA-Z]{2,20}$/; //wyrażenie regularne dla nazwiska
obiektemail =
...
if (!sprawdzPole("town",obiektTown))
{ ok=false;
document.getElementById("town_error").style.display="block";
document.getElementById("town_error").innerHTML=
"Wpisz poprawne miasto!";
document.getElementById("town_error").style.color = "red";
}
else document.getElementById("town_error").style.display="none";
if (!ValidateDate())
{
	ok=false;
...
var time = today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds();
	...
	item.town=document.getElementById('town').value;
...
function redirect()
{
	window.location.replace("booking2.html");
}
...
function selectchange()
{
	...
	document.getElementById("town").value=object.town;
